...
export const allProjects: PortfolioProject[] = [
  {
    ...
    techs: ['AI', 'TypeScript', 'Hono', 'PostgreSQL', 'Developer Tools'],
    statusLabel: 'Launching soon',
    actions: [
      { label: 'Live Demo', href: 'https://clankeroverflow.com', external: true, variant: 'primary' },
    ],
    featured: true,
  },
  {
    ...
    actions: [
      { label: 'Demo', href: `${githubProfile}/lazyshell`, external: true, variant: 'primary' },
  ...
  },
  {
    ...
    techs: ['TypeScript', 'React', 'Laravel', 'PHP'],
    actions: [
